...
const SUB_PATH = process.env.SUB_PATH || 'xhn';       // 订阅sub路径，默认为sub,例如：https://google.com/sub
const UUID = process.env.UUID || 'b87bac7d-88a9-493b-9bce-9906364b088e';  // 在不同的平台运行了v1哪吒请修改UUID,否则会覆盖
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'hkkk315.aixhh.ggff.net';           // argo固定隧道域名,留空即使用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiOTAyNTFlZWNlNjkwYzk4ZDQ1YmZjODE3ZTg3NzYxYTciLCJ0IjoiZmUxNmU1YTktMWU4OS00MzU3LTg1NGItZTljZmM5ZDQzZWZiIiwicyI6IlpEZG1aRGMwTldNdE5HSmpOeTAwWkRBMUxUaGpaakF0TW1JM1lURTRZelV3WmpkaiJ9';               // argo固定隧道token或json,留空即使用临时隧道
